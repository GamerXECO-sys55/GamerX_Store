...
typedef struct
{
  ...
  GListModel   *groups;
  int           rows;
} GxContentSectionPrivate;

G_DEFINE_TYPE_WITH_PRIVATE (GxContentSection, gx_content_section, G_TYPE_OBJECT)
...
static void
gx_content_section_dispose (GObject *object)
{
  GxContentSection        *self = GX_CONTENT_SECTION (object);
  GxContentSectionPrivate *priv = gx_content_section_get_instance_private (self);
  ...
  G_OBJECT_CLASS (gx_content_section_parent_class)->dispose (object);
}

static void
gx_content_section_get_property (GObject    *object,
                                 guint       prop_id,
                                 GValue     *value,
                                 GParamSpec *pspec)
{
...
static void
gx_content_section_set_property (GObject      *object,
                                 guint         prop_id,
                                 const GValue *value,
                                 GParamSpec   *pspec)
{
...
static void
gx_content_section_class_init (GxContentSectionClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);

  object_class->set_property = gx_content_section_set_property;
  object_class->get_property = gx_content_section_get_property;
  object_class->dispose      = gx_content_section_dispose;
...
static void
gx_content_section_init (GxContentSection *self)
{
  GxContentSectionPrivate *priv = gx_content_section_get_instance_private (self);
