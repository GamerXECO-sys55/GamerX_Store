...
G_DEFINE_ABSTRACT_TYPE_WITH_PRIVATE (GxReview, gx_review, G_TYPE_OBJECT)
...
static void
gx_review_dispose (GObject *object)
{
  GxReview        *self = GX_REVIEW (object);
  GxReviewPrivate *priv = gx_review_get_instance_private (self);
  ...
  G_OBJECT_CLASS (gx_review_parent_class)->dispose (object);
}

static void
gx_review_get_property (GObject    *object,
                        guint       prop_id,
                        GValue     *value,
                        GParamSpec *pspec)
{
...
static void
gx_review_set_property (GObject      *object,
                        guint         prop_id,
                        const GValue *value,
                        GParamSpec   *pspec)
{
...
static void
gx_review_class_init (GxReviewClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);

  object_class->set_property = gx_review_set_property;
  object_class->get_property = gx_review_get_property;
  object_class->dispose      = gx_review_dispose;
