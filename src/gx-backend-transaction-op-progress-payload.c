...
struct _GxBackendTransactionOpProgressPayload
{
...
G_DEFINE_FINAL_TYPE (GxBackendTransactionOpProgressPayload, gx_backend_transaction_op_progress_payload, G_TYPE_OBJECT);
...
static void
gx_backend_transaction_op_progress_payload_dispose (GObject *object)
{
  GxBackendTransactionOpProgressPayload *self = GX_BACKEND_TRANSACTION_OP_PROGRESS_PAYLOAD (object);

  g_clear_pointer (&self->op, g_object_unref);
  g_clear_pointer (&self->status, g_free);

  G_OBJECT_CLASS (gx_backend_transaction_op_progress_payload_parent_class)->dispose (object);
}

static void
gx_backend_transaction_op_progress_payload_get_property (GObject    *object,
                                                         guint       prop_id,
                                                         GValue     *value,
                                                         GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_OP:
      g_value_set_object (value, gx_backend_transaction_op_progress_payload_get_op (self));
      break;
    case PROP_STATUS:
      g_value_set_string (value, gx_backend_transaction_op_progress_payload_get_status (self));
      break;
    case PROP_IS_ESTIMATING:
      g_value_set_boolean (value, gx_backend_transaction_op_progress_payload_get_is_estimating (self));
      break;
    case PROP_PROGRESS:
      g_value_set_double (value, gx_backend_transaction_op_progress_payload_get_progress (self));
      break;
    case PROP_TOTAL_PROGRESS:
      g_value_set_double (value, gx_backend_transaction_op_progress_payload_get_total_progress (self));
      break;
    case PROP_BYTES_TRANSFERRED:
      g_value_set_uint64 (value, gx_backend_transaction_op_progress_payload_get_bytes_transferred (self));
      break;
    case PROP_START_TIME:
      g_value_set_uint64 (value, gx_backend_transaction_op_progress_payload_get_start_time (self));
      break;
    default:
...
static void
gx_backend_transaction_op_progress_payload_set_property (GObject      *object,
                                                         guint         prop_id,
                                                         const GValue *value,
                                                         GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_OP:
      gx_backend_transaction_op_progress_payload_set_op (self, g_value_get_object (value));
      break;
    case PROP_STATUS:
      gx_backend_transaction_op_progress_payload_set_status (self, g_value_get_string (value));
      break;
    case PROP_IS_ESTIMATING:
      gx_backend_transaction_op_progress_payload_set_is_estimating (self, g_value_get_boolean (value));
      break;
    case PROP_PROGRESS:
      gx_backend_transaction_op_progress_payload_set_progress (self, g_value_get_double (value));
      break;
    case PROP_TOTAL_PROGRESS:
      gx_backend_transaction_op_progress_payload_set_total_progress (self, g_value_get_double (value));
      break;
    case PROP_BYTES_TRANSFERRED:
      gx_backend_transaction_op_progress_payload_set_bytes_transferred (self, g_value_get_uint64 (value));
      break;
    case PROP_START_TIME:
      gx_backend_transaction_op_progress_payload_set_start_time (self, g_value_get_uint64 (value));
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
    }
...
static void
gx_backend_transaction_op_progress_payload_class_init (GxBackendTransactionOpProgressPayloadClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);

  object_class->set_property = gx_backend_transaction_op_progress_payload_set_property;
  object_class->get_property = gx_backend_transaction_op_progress_payload_get_property;
  object_class->dispose      = gx_backend_transaction_op_progress_payload_dispose;
...
static void
gx_backend_transaction_op_progress_payload_init (GxBackendTransactionOpProgressPayload *self)
{
}
...
{
  return g_object_new (GX_TYPE_BACKEND_TRANSACTION_OP_PROGRESS_PAYLOAD, NULL);
}
...
{
  g_return_val_if_fail (GX_IS_BACKEND_TRANSACTION_OP_PROGRESS_PAYLOAD (self), NULL);
  return self->op;
}
...
{
  g_return_val_if_fail (GX_IS_BACKEND_TRANSACTION_OP_PROGRESS_PAYLOAD (self), FALSE);
...
{
  g_return_val_if_fail (GX_IS_BACKEND_TRANSACTION_OP_PROGRESS_PAYLOAD (self), 0.0);
...
{
  g_return_val_if_fail (GX_IS_BACKEND_TRANSACTION_OP_PROGRESS_PAYLOAD (self), 0);
...
gx_backend_transaction_op_progress_payload_set_op (GxBackendTransactionOpProgressPayload *self,
                                                   GxBackendTransactionOpPayload         *op)
{
  g_return_if_fail (GX_IS_BACKEND_TRANSACTION_OP_PROGRESS_PAYLOAD (self));
