...
#define G_LOG_DOMAIN "GAMERX_STORE::DL-WORKER-SUBPROCESS"
...
GX_DEFINE_DATA (
    ...
    GX_RELEASE_DATA (src, g_free);
    GX_RELEASE_DATA (dest, g_free));
...
download_fiber (DownloadData *data)
{
  ...
  success = dex_await (gx_send_with_global_http_session_then_splice_into (
